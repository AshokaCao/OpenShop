...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_deleteBtn setImage:[UIImage imageNamed:@"tupianquxiao_icon"] forState:UIControlStateNormal];
        CGFloat deleteH = _deleteBtn.currentImage.size.height;
        _deleteBtn.frame = CGRectMake(self.tz_width - deleteH, 0, deleteH, deleteH);
...
- (void)layoutSubviews {
    ...
    _imageView.frame = CGRectMake(0, 8, self.tz_width - 8, self.tz_width - 8);
