...
@interface MakeupDataViewController () <SDCycleScrollViewDelegate, UITableViewDelegate, UITableViewDataSource, HomeGoodListTableViewCellDelegate>
...
@implementation MakeupDataViewController
