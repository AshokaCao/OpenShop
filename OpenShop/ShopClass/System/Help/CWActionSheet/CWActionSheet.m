...
- (UIButton *)cancleBtn
{
    if (!_cancleBtn) {
        ...
        [_cancleBtn setTitle:ASLocalizedString(@"cancel") forState:UIControlStateNormal];
        [_cancleBtn setTitleColor:[UIColor colorWithHexString:@"#111111"] forState:UIControlStateNormal];
