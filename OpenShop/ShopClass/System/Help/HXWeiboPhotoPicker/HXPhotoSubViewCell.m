...
- (void)setup
{
    ...
    [deleteBtn setImage:[UIImage imageNamed:@"tupianquxiao_icon"] forState:UIControlStateNormal];
...
- (void)layoutSubviews
{
    ...
    self.imageView.frame = CGRectMake(0, 8, self.frame.size.width - 8, self.frame.size.height - 8);
