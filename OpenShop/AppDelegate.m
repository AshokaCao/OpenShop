...
- (void)shareOut
{
    [ShareSDK registerApp:@"1ce2f138005c8"
          activePlatforms:@[
          ...
          onConfiguration:^(SSDKPlatformType platformType, NSMutableDictionary *appInfo) {
              ...
              switch (platformType)
              {
                  case SSDKPlatformTypeFacebook:
                      ...
                      [appInfo SSDKSetupFacebookByApiKey:@"281830092244727" appSecret:@"6a0c6a1c7005141fbad2cf59709781ec" authType:SSDKAuthTypeBoth];
                      break;
                  case SSDKPlatformTypeTwitter:
                      [appInfo SSDKSetupTwitterByConsumerKey:@"bzCUnDclNbYyaF2adaBnl3F0H"
                                              consumerSecret:@"tMi6Ks3ElbdqleX2QHheSTFGnZX7cm2hXBcSoWSpNwhR8kNCU4"
                                                 redirectUri:@"http://www.deedeefun.com"];
                      break;
                  case SSDKPlatformTypeInstagram:
                      [appInfo SSDKSetupInstagramByClientID:@"7a1b7c00292d4ed9a214e5ba5e5d282f"
                                               clientSecret:@"30c7389612a1475b8a59015c992171b6"
                                                redirectUri:@"http://www.deedeefun.com/"];
                      break;
